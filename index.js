...
function checkemail(email)
{
    ...
    if(email.length > 8 && email.include('@gmail'))
    {
        ...
        document.getElementById('email_error').innerText = 'Email length must include @gmail, 8 letter long'
...
function checkpassword(password)
{
    ...
    if(password.length > 8 && password.include('.'))
    {
        ...
        document.getElementById('password_error').innerText = 'password must be include ., 8 letter long'
